...
| `window.arrowsShown` | property `bool` | `Main.qml` | drives `previousButton`/`nextButton` `shown` |
...
| F-030 | none (unchanged file) | existing `footer_key_hints_test.cpp` suite passes unmodified — confirms `FooterKeyHints.qml` untouched |

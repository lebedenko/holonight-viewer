...
class ImageCanvas : public QQuickPaintedItem {
  ...
  Q_PROPERTY(QSizeF svgSize READ svgSize WRITE setSvgSize NOTIFY imageChanged)
 ...
 private:
  ...
  QSizeF svg_size_;
  QSizeF content_size_;  // Intrinsic size in content units, raster or vector.
  ViewGeometry view_;
